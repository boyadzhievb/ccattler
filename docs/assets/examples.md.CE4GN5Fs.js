...
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">cca</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> run-container</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> examples/basic.ccattler</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"> # Docker containers</span></span></code></pre></div><h2 id="multiple-services" tabindex="-1">Multiple services <a class="header-anchor" href="#multiple-services" aria-label="Permalink to &quot;Multiple services&quot;">​</a></h2><p>Two services with different resource profiles.</p><div class="language-hcl vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">hcl</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">service</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> web</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> {</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    image nginx</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">:</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">1.28</span></span>
